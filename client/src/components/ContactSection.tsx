          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-white/60 text-lg leading-relaxed">
                Solicita una demo gratuita. Nuestro equipo te contactará en
                menos de 24 horas para activar tu plataforma.
              </p>
            </div>
              ...
              {[
                {
                  icon: Mail,
                  label: "Email",
                  value: config.contactEmail || "hola@whatsapptaxi.com",
                },
                {
                  icon: Phone,
                  label: "Teléfono",
                  value: config.contactPhone || "+1 (555) 000-0000",
                },
                {
                  icon: MapPin,
                  label: "Ubicación",
                  value: config.contactAddress || "Orlando, Florida, USA",
                },
            ...
            {submitted ? (
              ...
              >
                ...
                <div className="relative">
                  <div
                    ...
                    style={{
                      ...
                      animation:
                        "scaleIn 0.5s cubic-bezier(0.23,1,0.32,1) both",
                    }}
                  >
                    <CheckCircle2
                      size={40}
                  ...
                  <div
                    ...
                    style={{
                      ...
                      animation:
                        "pingOnce 1s cubic-bezier(0,0,0.2,1) 0.3s both",
                    }}
                  />
                </div>
                ...
                <div
                  ...
                  style={{
                    background: "oklch(0.76 0.18 148 / 0.08)",
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <Label
                      className={`text-xs font-medium ${errors.name ? "text-red-400" : "text-white/70"}`}
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    <Label
                      className={`text-xs font-medium ${errors.email ? "text-red-400" : "text-white/70"}`}
                    >
                ...
                <div className="flex flex-col gap-1.5">
                  <Label
                    className={`text-xs font-medium ${errors.message ? "text-red-400" : "text-white/70"}`}
                  >
                ...
                {submitError && (
                  <div
                    ...
                    style={{
                      ...
                      animation:
                        "fadeInUp 0.3s cubic-bezier(0.23,1,0.32,1) both",
                    }}
                  >
                    <XCircle
                      size={18}

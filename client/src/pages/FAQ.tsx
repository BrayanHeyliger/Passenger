...
const defaultFAQs: FAQItem[] = [
  ...
  { category: "💳 Pagos y tarifas", q: "¿Cuáles son los métodos de pago aceptados?", a: "El pasajero paga directamente al conductor. Antes de elegirlo podrás ver si acepta efectivo, Zelle, Cash App, PayPal o transferencia. UnPasajero.Com no recibe ni procesa el dinero del viaje." },

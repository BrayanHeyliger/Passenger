...
const weeklyData = [
  { day: "Lun", viajes: 38, ingresos: 760 },
  { day: "Mar", viajes: 52, ingresos: 1040 },
  { day: "Mié", viajes: 45, ingresos: 900 },
  { day: "Jue", viajes: 61, ingresos: 1220 },
  { day: "Vie", viajes: 78, ingresos: 1560 },
  { day: "Sáb", viajes: 95, ingresos: 1900 },
  { day: "Dom", viajes: 72, ingresos: 1440 },
];

const monthlyData = [
  { month: "Ene", viajes: 820, ingresos: 16400 },
  { month: "Feb", viajes: 950, ingresos: 19000 },
  { month: "Mar", viajes: 1100, ingresos: 22000 },
  { month: "Abr", viajes: 980, ingresos: 19600 },
  { month: "May", viajes: 1250, ingresos: 25000 },
  { month: "Jun", viajes: 1400, ingresos: 28000 },
...
const defaultSiteConfig = {
  ...
  heroDesc:
    "La plataforma de movilidad que unifica reservas, asignación, seguimiento y operación de flotillas.",
...
export default function AdminDashboard() {
  ...
  const handleTestSmtp = async () => {
    ...
    if (!cfg.smtpHost || !cfg.smtpUser || !cfg.smtpPass) {
      setSmtpTestResult({
        ok: false,
        msg: "Completa servidor, usuario y contraseña SMTP antes de probar.",
      });
      return;
    }
    if (!cfg.notificationEmail) {
      setSmtpTestResult({
        ok: false,
        msg: "Ingresa el email de notificaciones para recibir el correo de prueba.",
      });
      return;
    }
    setTestingSmtp(true);
    ...
    testSmtpMutation.mutate(
      {
        ...
        testEmail: cfg.notificationEmail,
      },
      {
        onSuccess: data => {
  ...
  const [sentMessages, setSentMessages] = useState<SentMessage[]>([
    {
      id: "m1",
      to: "all_clients",
      subject: "¡Bienvenido a WhatsApp Taxi!",
    ...
    },
    {
      id: "m2",
      to: "all_drivers",
      subject: "Actualización de tarifas",
      body: "Las tarifas se han actualizado.",
      channel: "email",
      date: "Ayer 14:30",
    },
  ]);
  ...
  const handleDriverAction = (
    ...
    setDrivers(prev =>
      prev
        .map(d => {
          ...
          if (action === "suspend")
            return { ...d, status: "suspended" as const, online: false };
    ...
    toast.success(
      {
        approve: "Conductor aprobado ✅",
        suspend: "Conductor suspendido",
        activate: "Conductor activado ✅",
    ...
    setDrivers(prev =>
      prev.map(d =>
        d.id !== driverId
          ...
          : {
              ...d,
              permissions: { ...d.permissions, [perm]: !d.permissions[perm] },
            }
      )
    );
  ...
  const handleClientAction = (
    ...
    toast.success(
      action === "suspend" ? "Cliente suspendido" : "Cliente activado ✅"
    );
  };
    ...
    setSentMessages(prev => [
      {
        ...
        date: new Date().toLocaleTimeString("es", {
          hour: "2-digit",
          minute: "2-digit",
        }),
      },
    ...
    <div className="min-h-screen bg-slate-50 flex">
        ...
        <div className="p-5 border-b border-slate-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-400">Acceso total al sistema</p>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-6">
                ...
                {[
                  {
                    ...
                    value: `${drivers.filter(d => d.status === "active").length}/${drivers.length}`,
                    sub: `${drivers.filter(d => d.online).length} en línea`,
                    icon: Car,
                  ...
                  },
                  {
                    ...
                    sub: `${clients.filter(c => c.status === "active").length} activos`,
                    icon: Users,
                    color: "text-blue-600",
                    bg: "bg-blue-50",
                  },
                  ...
                  <Card key={i} className="p-4">
                    <div
                      className={`w-10 h-10 rounded-xl ${kpi.bg} flex items-center justify-center mb-2`}
                    >
                ...
                <Card className="p-4 border-yellow-200 bg-yellow-50">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-yellow-800">
                      ...
                      conductor(es) esperando aprobación
                    </p>
                    <Button
                      size="sm"
                      onClick={() => setActiveTab("drivers")}
                      className="ml-auto bg-yellow-500 hover:bg-yellow-600 text-white text-xs gap-1"
                    >
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-bold text-slate-900">
                    God's Eye — Mapa en Tiempo Real
                  </h2>
                  <p className="text-sm text-slate-500">
                    Todos los conductores activos en tiempo real
                  </p>
                </div>
                <div className="flex gap-3 text-xs">
                  {[
                    { color: "bg-green-500", label: "Disponible" },
                    { color: "bg-blue-500", label: "En viaje" },
                    { color: "bg-slate-400", label: "Inactivo" },
                    { color: "bg-red-500", label: "Suspendido" },
                  ].map(s => (
                  ...
                  <Card className="p-4">
                    ...
                    <div className="space-y-2">
                      {drivers.map(d => (
                        <div
                          key={d.id}
                          className="flex items-center gap-2.5 p-2 rounded-lg hover:bg-slate-50"
                        >
                          ...
                          <span
                            className={`text-xs px-1.5 py-0.5 rounded-full font-medium ${statusColors[d.status]}`}
                          >
                            {d.online ? "●" : "○"}
                          </span>
                        </div>
                  ...
                  <Card className="p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-slate-500">En línea</span>
                ...
                <Card className="p-4 border-yellow-200 bg-yellow-50">
                  ...
                  {drivers
                    ...
                    .map(d => (
                      <div
                        key={d.id}
                        className="flex items-center justify-between py-2 border-t border-yellow-200"
                      >
                        <div>
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            className="bg-green-500 hover:bg-green-600 text-white text-xs gap-1"
                          >
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => handleDriverAction(d.id, "delete")}
                            className="text-red-500 border-red-200 text-xs gap-1"
                          >
                      ...
                      {drivers
                        ...
                        .map(d => (
                          <tr key={d.id} className="hover:bg-slate-50">
                            ...
                            <td className="px-4 py-3">
                              <p className="text-slate-900">{d.vehicle}</p>
                            ...
                            <td className="px-4 py-3">
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium ${statusColors[d.status]}`}
                              >
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-1">
                                ...
                                {d.status === "active" && (
                                  <button
                                    onClick={() =>
                                      handleDriverAction(d.id, "suspend")
                                    }
                                ...
                                {(d.status === "suspended" ||
                                  ...
                                  <button
                                    onClick={() =>
                                      handleDriverAction(d.id, "activate")
                                    }
                                ...
                                {d.status === "pending" && (
                                  <button
                                    onClick={() =>
                                      handleDriverAction(d.id, "approve")
                                    }
                      ...
                      {clients
                        ...
                        .map(c => (
                          <tr key={c.id} className="hover:bg-slate-50">
                            ...
                            <td className="px-4 py-3">
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium ${c.status === "active" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                              >
                                {c.status === "active"
                                  ? "Activo"
                                  : "Suspendido"}
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-1">
                                ...
                                {c.status === "active" ? (
                                  <button
                                    onClick={() =>
                                      handleClientAction(c.id, "suspend")
                                    }
                                    className="p-1.5 rounded-lg hover:bg-red-50 text-red-500"
                                    title="Suspender"
                                  >
                                  ...
                                  <button
                                    onClick={() =>
                                      handleClientAction(c.id, "activate")
                                    }
                                    className="p-1.5 rounded-lg hover:bg-green-50 text-green-500"
                                    title="Activar"
                                  >
          ...
          {activeTab === "trips" && (
            <div className="space-y-4">
              <div className="grid grid-cols-4 gap-3">
                {[
                  { label: "Total Hoy", value: "47", color: "text-slate-700" },
                  {
                    label: "Completados",
                    value: "38",
                    color: "text-green-600",
                  },
                  { label: "En progreso", value: "6", color: "text-blue-600" },
                  { label: "Cancelados", value: "3", color: "text-red-600" },
                ].map((s, i) => (
                ...
                <div className="space-y-3">
                  {[
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-2.5 h-2.5 rounded-full ${t.status === "in_progress" ? "bg-blue-500 animate-pulse" : t.status === "completed" ? "bg-green-500" : "bg-yellow-500"}`}
                        />
                        <div>
              ...
              <Card className="p-4 bg-blue-50 border-blue-200">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-blue-800 font-medium">
                    Gestiona los permisos individuales de cada conductor. Los
                  ...
                  .map(d => (
                    <Card key={d.id} className="p-5">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-slate-500">
                            {d.vehicle} ·{" "}
                            <span
                              className={`font-medium ${d.status === "active" ? "text-green-600" : "text-red-600"}`}
                            >
                              {statusLabels[d.status]}
                            </span>
                          </p>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {[
                          {
                            key: "canAcceptTrips" as const,
                            label: "Aceptar viajes",
                            desc: "Puede recibir solicitudes",
                            icon: Navigation,
                          },
                          {
                            key: "canViewClientPhone" as const,
                            label: "Ver teléfono del cliente",
                            desc: "Acceso al número del pasajero",
                            icon: Phone,
                          },
                          {
                            key: "canSetOwnFare" as const,
                            label: "Establecer tarifa propia",
                            desc: "Puede modificar el precio",
                            icon: DollarSign,
                          },
                          {
                            key: "canCancelTrip" as const,
                            label: "Cancelar viajes",
                            desc: "Puede cancelar viajes aceptados",
                            icon: XCircle,
                          },
                        ].map(perm => (
                          <div
                            key={perm.key}
                            className={`flex items-start gap-3 p-3 rounded-xl border transition-colors ${d.permissions[perm.key] ? "bg-green-50 border-green-200" : "bg-slate-50 border-slate-200"}`}
                          >
                            <div
                              className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${d.permissions[perm.key] ? "bg-green-500" : "bg-slate-300"}`}
                            >
                              <perm.icon size={14} className="text-white" />
                            </div>
                            <div className="flex-1 min-w-0">
                            ...
                            <button
                              onClick={() =>
                                handlePermissionToggle(d.id, perm.key)
                              }
                              className={`flex-shrink-0 w-10 h-6 rounded-full transition-colors relative ${d.permissions[perm.key] ? "bg-green-500" : "bg-slate-300"}`}
                            >
                              <div
                                className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${d.permissions[perm.key] ? "translate-x-4" : "translate-x-0.5"}`}
                              />
                            </button>
                          </div>
                        ))}
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-colors ${editorView === "form" ? "bg-green-500 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"}`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-colors ${editorView === "preview" ? "bg-blue-500 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"}`}
                  >
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className="gap-2 text-sm bg-green-500 hover:bg-green-600 text-white"
                  >
                    {isSaving ? (
                  ...
                  <div className="flex items-center justify-between px-4 py-2 bg-slate-50 border-b border-slate-200">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-slate-500 font-mono ml-2">
                        whatsapptaxi.com — Vista previa en vivo
                      </span>
                    </div>
                    <button
                      onClick={() => setPreviewKey(k => k + 1)}
                      className="flex items-center gap-1.5 text-xs text-slate-500 hover:text-slate-700 px-2 py-1 rounded hover:bg-slate-200 transition-colors"
                    >
              ...
              {editorView === "form" && (
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                  <div className="space-y-1">
                    {[
                      {
                        id: "hero" as EditorSection,
                        label: "Hero / Inicio",
                        icon: Monitor,
                      },
                      {
                        id: "colors" as EditorSection,
                        label: "Colores y Fuentes",
                        icon: Palette,
                      },
                      {
                        id: "contact" as EditorSection,
                        label: "Contacto",
                        icon: Phone,
                      },
                      {
                        id: "footer" as EditorSection,
                        label: "Footer",
                        icon: Layers,
                      },
                      {
                        id: "meta" as EditorSection,
                        label: "SEO / Meta Tags",
                        icon: Globe,
                      },
                      {
                        id: "features" as EditorSection,
                        label: "Funcionalidades",
                        icon: Sliders,
                      },
                      {
                        id: "pricing" as EditorSection,
                        label: "Precios y Tarifas",
                        icon: DollarSign,
                      },
                      {
                        id: "testimonials" as EditorSection,
                        label: "Testimonios",
                        icon: Star,
                      },
                      {
                        id: "vehicles" as EditorSection,
                        label: "Vehículos y Extras",
                        icon: Car,
                      },
                      {
                        id: "email" as EditorSection,
                        label: "Email / SMTP",
                        icon: Mail,
                      },
                    ].map(s => (
                      <button
                        ...
                        className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors ${editorSection === s.id ? "bg-green-500 text-white" : "text-slate-600 hover:bg-slate-100"}`}
                      >
                        <s.icon size={15} />
                        {s.label}
                      </button>
                    ...
                    <Button
                      onClick={handleSaveConfig}
                      className="w-full mt-3 bg-green-500 hover:bg-green-600 text-white gap-2 text-sm"
                    >
                  ...
                  <Card className="lg:col-span-3 p-5">
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <input
                                  ...
                                  onChange={e => {
                                    ...
                                    reader.onload = ev => {
                                      ...
                                      toast.success(
                                        "Logo cargado. Haz clic en Guardar para aplicarlo."
                                      );
                                    };
                              ...
                              <p className="text-xs text-slate-400 mt-1.5">
                                Recomendado: 512×512px, fondo transparente (PNG)
                              </p>
                              {siteConfig.logoUrl && (
                                <button
                                  onClick={() =>
                                    setSiteConfig(c => ({ ...c, logoUrl: "" }))
                                  }
                        ...
                        <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                          <div>
                            ...
                            <p className="text-xs text-slate-500">
                              Demo de 60 segundos en "Cómo funciona"
                            </p>
                          </div>
                          <button
                            onClick={() =>
                              setSiteConfig(c => ({
                                ...c,
                                showAnimations: !c.showAnimations,
                              }))
                            }
                            className={`w-10 h-6 rounded-full transition-colors relative ${siteConfig.showAnimations ? "bg-green-500" : "bg-slate-300"}`}
                          >
                            <div
                              className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${siteConfig.showAnimations ? "translate-x-4" : "translate-x-0.5"}`}
                            />
                          </button>
                        </div>
                      </div>
                    ...
                    {editorSection === "colors" && (
                      <div className="space-y-4">
                        <h3 className="font-semibold text-slate-900 flex items-center gap-2">
                          <Palette size={16} /> Colores y Tipografía
                        </h3>
                        {[
                          {
                            key: "primaryColor",
                            label: "Color primario (verde WhatsApp)",
                          },
                          {
                            key: "secondaryColor",
                            label: "Color secundario (fondo oscuro)",
                          },
                          ...
                          <div key={f.key}>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <input
                                ...
                                className="flex-1 px-3 py-2.5 border border-slate-200 rounded-xl text-sm font-mono focus:ring-2 focus:ring-green-500 outline-none"
                              />
                            </div>
                          </div>
                        ))}
                    ...
                    {editorSection === "footer" && (
                      <div className="space-y-4">
                        ...
                        {[
                          ...
                          {
                            key: "footerLinks",
                            label: "Links del footer (separados por |)",
                          },
                        ].map(f => (
                          <div key={f.key}>
                            <label className="block text-sm font-medium text-slate-700 mb-1.5">
                        ...
                        <div className="p-3 bg-slate-900 rounded-xl">
                          ...
                          <div className="flex gap-3 mt-1">
                            {siteConfig.footerLinks.split("|").map((l, i) => (
                              <span
                                key={i}
                    ...
                    {editorSection === "features" && (
                      <div className="space-y-4">
                        <h3 className="font-semibold text-slate-900 flex items-center gap-2">
                          <Sliders size={16} /> Funcionalidades del Sitio
                        </h3>
                        {[
                          {
                            key: "showPricing",
                            label: "Mostrar sección de precios",
                            desc: "Visible en el landing page",
                          },
                          {
                            key: "showTestimonials",
                            label: "Mostrar testimonios",
                            desc: "Sección de reseñas",
                          },
                          {
                            key: "showAnimations",
                            label: "Demo animada (60 segundos)",
                            desc: "Animación en 'Cómo funciona'",
                          },
                          {
                            key: "allowRegistration",
                            label: "Permitir nuevos registros",
                            desc: "Habilitar formulario de registro",
                          },
                          {
                            key: "requireEmailVerification",
                            label: "Verificación de email",
                            desc: "Confirmar email al registrarse",
                          },
                          {
                            key: "maintenanceMode",
                            label: "Modo mantenimiento",
                            desc: "Mostrar página de mantenimiento",
                          },
                          {
                            key: "surgePricing",
                            label: "Tarifa dinámica activa",
                            desc: "Precios variables por demanda",
                          },
                        ].map(f => (
                          <div
                            key={f.key}
                          ...
                          >
                            ...
                            <button
                              onClick={() =>
                                setSiteConfig(c => ({
                                  ...c,
                                  [f.key]: !(c as any)[f.key],
                                }))
                              }
                              className={`w-10 h-6 rounded-full transition-colors relative ${(siteConfig as any)[f.key] ? "bg-green-500" : "bg-slate-300"}`}
                            >
                              <div
                                className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${(siteConfig as any)[f.key] ? "translate-x-4" : "translate-x-0.5"}`}
                              />
                            </button>
                          </div>
                        ))}
                    ...
                    {editorSection === "pricing" && (
                      <div className="space-y-4">
                        <h3 className="font-semibold text-slate-900 flex items-center gap-2">
                          <DollarSign size={16} /> Precios y Tarifas
                        </h3>
                        {[
                          {
                            key: "commissionRate",
                          ...
                          {
                            key: "surgeMultiplier",
                            label: "Multiplicador de hora pico (×)",
                          },
                        ].map(f => (
                          <div key={f.key}>
                            <label className="block text-sm font-medium text-slate-700 mb-1.5">
                        ...
                        <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                          <p className="text-sm font-semibold text-green-800 mb-2">
                            Ejemplo de tarifa calculada:
                          </p>
                          <p className="text-xs text-green-700">
                            Viaje de 10 km = $
                            {(
                              parseFloat(siteConfig.basefare) +
                              10 * parseFloat(siteConfig.pricePerKm)
                            ).toFixed(2)}{" "}
                            (tarifa normal)
                          </p>
                          <p className="text-xs text-green-700">
                            Con surge ×{siteConfig.surgeMultiplier} = $
                            {(
                              (parseFloat(siteConfig.basefare) +
                                10 * parseFloat(siteConfig.pricePerKm)) *
                              parseFloat(siteConfig.surgeMultiplier)
                            ).toFixed(2)}
                          </p>
                        </div>
                      </div>
                  ...
                  {editorSection === "testimonials" && (
                    <div className="space-y-4">
                      <h3 className="font-semibold text-slate-900 flex items-center gap-2">
                        <Star size={16} /> Testimonios de Clientes
                      </h3>
                      <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                        <div>
                          <p className="text-sm font-medium text-slate-900">
                            Mostrar testimonios en el landing
                          </p>
                          <p className="text-xs text-slate-500">
                            Activa para que sean visibles
                          </p>
                        </div>
                        <button
                          onClick={() =>
                          ...
                          className={`w-10 h-6 rounded-full transition-colors relative ${siteConfig.showTestimonials ? "bg-green-500" : "bg-slate-300"}`}
                        >
                          <div
                            className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${siteConfig.showTestimonials ? "translate-x-4" : "translate-x-0.5"}`}
                          />
                        </button>
                      </div>
                      {((siteConfig as any).testimonials || []).map(
                        (t: any, idx: number) => (
                          <div
                            key={t.id}
                            className="p-4 border border-slate-200 rounded-xl space-y-3 bg-slate-50"
                          >
                            <div className="flex items-center justify-between">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={e => {
                                    const ts = [
                                      ...(siteConfig as any).testimonials,
                                    ];
                                    ts[idx] = {
                                      ...ts[idx],
                                      name: e.target.value,
                                ...
                                {[1, 2, 3, 4, 5].map(star => (
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      ts[idx] = { ...ts[idx], rating: star };
                                      setSiteConfig(
                                        c => ({ ...c, testimonials: ts }) as any
                                      );
                                    }}
                                    className={`text-xl transition-transform hover:scale-110 ${star <= t.rating ? "text-yellow-400" : "text-slate-300"}`}
                                  >
                                    ★
                                  </button>
                                ))}
                      ...
                      <button
                        ...
                        className="w-full py-3 border-2 border-dashed border-green-300 rounded-xl text-green-600 text-sm font-medium hover:bg-green-50 transition-colors flex items-center justify-center gap-2"
                      >
                        + Agregar testimonio
                      </button>
                      {((siteConfig as any).testimonials || []).length ===
                        0 && (
                        <div className="text-center py-8 text-slate-400">
                          <Star size={32} className="mx-auto mb-2 opacity-30" />
                          <p className="text-sm">
                            No hay testimonios. Haz clic en "Agregar
                            testimonio".
                          </p>
                        </div>
                      )}
                  ...
                  {editorSection === "vehicles" && <VehiclesExtrasEditor />}
                  {editorSection === "email" && (
                    <div className="space-y-4">
                      <h3 className="font-semibold text-slate-900 flex items-center gap-2">
                        <Mail size={16} /> Configuración de Email
                      </h3>
                      <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                        ...
                        <p className="text-xs text-blue-600">
                          Los mensajes del formulario de contacto y alertas
                          llegarán a este correo.
                        </p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1.5">
                        ...
                        <input
                          type="email"
                          value={(siteConfig as any).notificationEmail || ""}
                          onChange={e =>
                            setSiteConfig(
                              c =>
                                ({
                          ...
                          className="w-full px-3 py-2.5 border-2 border-green-300 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none"
                        />
                      </div>
                      <div className="border-t border-slate-200 pt-4">
                        ...
                        <p className="text-xs text-slate-500 mb-3">
                          Si configuras SMTP, los emails se enviarán desde tu
                          propio servidor. Si lo dejas vacío, se usará el
                        ...
                        <div className="mb-3">
                          ...
                          <input
                            type="password"
                            value={(siteConfig as any).smtpPass || ""}
                            onChange={e =>
                              setSiteConfig(
                                c => ({ ...c, smtpPass: e.target.value }) as any
                              )
                            }
                            placeholder="••••••••"
                            className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-green-500 outline-none"
                      ...
                      <div className="p-4 bg-amber-50 rounded-xl border border-amber-200">
                        <p className="text-xs text-amber-700">
                          <strong>Gmail:</strong> Usa "Contraseña de
                          aplicación". Ve a Google Account → Seguridad →
                      ...
                      <div className="border-t border-slate-200 pt-4 space-y-3">
                        <button
                          ...
                          style={{
                            background: testingSmtp ? "#94a3b8" : "#3B82F6",
                          }}
                        >
                          {testingSmtp ? (
                            <>
                            ...
                            <>
                              <Mail size={15} /> Enviar email de prueba al
                              correo configurado
                            </>
                          )}
                        </button>
                        {smtpTestResult && (
                          <div
                            className={`p-3 rounded-xl text-sm flex items-start gap-2 ${smtpTestResult.ok ? "bg-green-50 border border-green-200 text-green-800" : "bg-red-50 border border-red-200 text-red-800"}`}
                          >
                            {smtpTestResult.ok ? (
                              <CheckCircle
                                size={16}
                ...
                {[
                  {
                    ...
                    value: "68%",
                    sub: "Solicitudes → Completados",
                    color: "text-green-600",
                  },
                  {
                    label: "Tiempo promedio",
                    value: "4.2 min",
                    sub: "Espera hasta asignación",
                    color: "text-blue-600",
                  },
                  {
                    label: "Ticket promedio",
                    value: "$18.50",
                    sub: "Por viaje completado",
                    color: "text-purple-600",
                  },
                  {
                    label: "NPS Score",
              ...
              <Card className="p-6 border-2 border-violet-100">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div className="ml-auto">
                      ...
                      onClick={() =>
                        setSiteConfig(
                          c =>
                            ({
                              ...c,
                              stripeEnabled: !(c as any).stripeEnabled,
                            }) as any
                        )
                      }
                    ...
                    >
                      <div
                        className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${(siteConfig as any).stripeEnabled ? "translate-x-6" : "translate-x-0.5"}`}
                      />
                    </button>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  {(!(siteConfig as any).stripeMode ||
                    (siteConfig as any).stripeMode === "test") && (
                    <p className="text-xs text-amber-600 mt-1.5 bg-amber-50 px-3 py-1.5 rounded-lg">
                      Tarjeta de prueba: <strong>4242 4242 4242 4242</strong> —
                  ...
                  {[
                    ...
                    <div key={f.key}>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setSiteConfig(
                            c => ({ ...c, [f.key]: e.target.value }) as any
                          )
                        }
                        placeholder={f.placeholder}
                ...
                <div className="mt-4 p-3 bg-slate-50 rounded-xl border border-slate-200">
                  ...
                  <ol className="text-xs text-slate-500 space-y-0.5 list-decimal list-inside">
                    ...
                    <li>
                      Para el Webhook: Developers → Webhooks → Add endpoint
                    </li>
                    <li>
                      URL del webhook:{" "}
              ...
              <Card className="p-6 border-2 border-blue-100">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div className="ml-auto">
                      ...
                      onClick={() =>
                        setSiteConfig(
                          c =>
                            ({
                              ...c,
                              paypalEnabled: !(c as any).paypalEnabled,
                            }) as any
                        )
                      }
                    ...
                    >
                      <div
                        className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${(siteConfig as any).paypalEnabled ? "translate-x-6" : "translate-x-0.5"}`}
                      />
                    </button>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      ...
                      placeholder: "ID del webhook en PayPal",
                      type: "text",
                    },
                  ].map(f => (
                    <div key={f.key}>
                ...
                <div className="mt-4 p-3 bg-slate-50 rounded-xl border border-slate-200">
                  ...
                  <ol className="text-xs text-slate-500 space-y-0.5 list-decimal list-inside">
                    ...
                    <li>
                      Para producción, activa tu cuenta de negocio verificada
                    </li>
                  </ol>
                </div>
              </Card>
          ...
          {/* ── DISPATCHERS ── */}
          {activeTab === "dispatchers" && <DispatcherAdminPanel />}
          ...
          {/* ── SURGE PRICING ── */}
          {activeTab === "surgePricing" && <SurgePricingPanel />}
          ...
          {/* ── SAFETY TIPS ── */}
          {activeTab === "safetyTips" && <SafetyTipsAdminPanel />}
                ...
                {[
                  ...
                  <Card key={f.key} className="p-4">
                    ...
                    <input
                      ...
                      value={(siteConfig as any)[f.key]}
                      onChange={e =>
                        setSiteConfig(c => ({ ...c, [f.key]: e.target.value }))
                      }
                      className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none"
                    />
                  </Card>
                ...
                {[
                  {
                    key: "allowRegistration",
                    label: "Permitir nuevos registros",
                    desc: "Usuarios pueden crear cuentas",
                  },
                  {
                    key: "requireEmailVerification",
                    label: "Verificación de email",
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-3">
              {[
                ...
                <div
                  key={perm.key}
                  className={`flex items-center justify-between p-3 rounded-xl border ${editingDriver.permissions[perm.key] ? "bg-green-50 border-green-200" : "bg-slate-50 border-slate-200"}`}
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-8 h-8 rounded-lg flex items-center justify-center ${editingDriver.permissions[perm.key] ? "bg-green-500" : "bg-slate-300"}`}
                    >
                      <perm.icon size={14} className="text-white" />
                    </div>
                    <p className="text-sm font-medium text-slate-900">
                  ...
                  <button
                    onClick={() => {
                      handlePermissionToggle(editingDriver.id, perm.key);
                      setEditingDriver(d =>
                        d
                          ? {
                              ...d,
                              permissions: {
                                ...d.permissions,
                                [perm.key]: !d.permissions[perm.key],
                              },
                            }
                          : null
                      );
                    }}
                    className={`w-10 h-6 rounded-full transition-colors relative ${editingDriver.permissions[perm.key] ? "bg-green-500" : "bg-slate-300"}`}
                  >
                    <div
                      className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${editingDriver.permissions[perm.key] ? "translate-x-4" : "translate-x-0.5"}`}
                    />
                  </button>
                </div>
              ))}
...
function ReferralAdminPanel() {
  const { data: allRewards, refetch } =
    trpc.referrals.getAllRewardsAdmin.useQuery();
  const saveReward = trpc.referrals.saveReward.useMutation({
    onSuccess: () => {
      refetch();
      toast.success("Recompensa guardada");
    },
  });
  const deleteReward = trpc.referrals.deleteReward.useMutation({
    onSuccess: () => {
      refetch();
  ...
  const [form, setForm] = useState({
    userRole: "client" as "client" | "driver",
    eventType: "",
    eventLabel: "",
    rewardType: "credit" as any,
    rewardValue: 0,
    rewardLabel: "",
    rewardDescription: "",
    triggerCount: 1,
  ...
  const [filterRole, setFilterRole] = useState<"all" | "client" | "driver">(
    "all"
  );
  ...
  const clientRewards =
    allRewards?.filter((r: any) => r.userRole === "client") || [];
  const driverRewards =
    allRewards?.filter((r: any) => r.userRole === "driver") || [];
  const filtered =
    filterRole === "all"
      ? allRewards || []
      : filterRole === "client"
  ...
  const rewardTypeColors: Record<string, string> = {
    ...
    free_trip: "bg-blue-100 text-blue-700",
    discount: "bg-purple-100 text-purple-700",
    badge: "bg-yellow-100 text-yellow-700",
    cash_bonus: "bg-emerald-100 text-emerald-700",
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Estadísticas del programa y configuración de recompensas
          </p>
        </div>
        {subTab === "rewards" && (
          <Button
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              {
                label: "Créditos dist.",
                value: `$${Number(stats?.totalCreditsDistributed || 0).toFixed(2)}`,
                color: "text-purple-600",
                sub: "total entregado",
              },
              {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="p-5">
              <h3 className="font-semibold text-slate-900 mb-4 flex items-center gap-2">
                <Trophy size={16} className="text-yellow-500" /> Top Clientes
                Referidores
              </h3>
              {!stats?.topClients || stats.topClients.length === 0 ? (
                ...
                <div className="space-y-2">
                  {stats.topClients.map((u: any, i: number) => (
                    ...
                    >
                      <span
                        className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${i === 0 ? "bg-yellow-400 text-white" : i === 1 ? "bg-slate-300 text-white" : i === 2 ? "bg-orange-400 text-white" : "bg-slate-100 text-slate-500"}`}
                      >
                        {i + 1}
                      </span>
                      <div className="flex-1 min-w-0">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-bold text-green-600">
                          {u.totalReferrals} ref.
                        </p>
                        <p className="text-xs text-slate-400">
                          ${Number(u.totalRewardsEarned || 0).toFixed(2)}
                        </p>
                      </div>
                    </div>
                  ))}
            ...
            <Card className="p-5">
              <h3 className="font-semibold text-slate-900 mb-4 flex items-center gap-2">
                <Trophy size={16} className="text-blue-500" /> Top Choferes
                Referidores
              </h3>
          ...
          {stats?.rewardBreakdown && stats.rewardBreakdown.length > 0 && (
            <Card className="p-5">
              <h3 className="font-semibold text-slate-900 mb-4">
                Recompensas Entregadas por Tipo
              </h3>
                ...
                {stats.rewardBreakdown.map((rb: any) => (
                  ...
                  >
                    ...
                    <p className="text-xs font-medium text-slate-600 capitalize">
                      {rb.rewardType?.replace("_", " ")}
                    </p>
                    <p className="text-xs text-slate-400">
                      ${Number(rb.totalValue || 0).toFixed(2)}
                    </p>
                  </div>
                ))}
              </div>
        ...
        <>
          ...
          <div className="grid grid-cols-3 gap-4">
            <Card className="p-4 text-center">
              ...
              <p className="text-sm text-slate-500">Total recompensas</p>
            </Card>
            <Card className="p-4 text-center">
              <p className="text-2xl font-bold text-green-600">
                {clientRewards.length}
              </p>
              <p className="text-sm text-slate-500">Para clientes</p>
            </Card>
            <Card className="p-4 text-center">
              <p className="text-2xl font-bold text-blue-600">
                {driverRewards.length}
              </p>
              <p className="text-sm text-slate-500">Para choferes</p>
            </Card>
          </div>
          ...
          <div className="space-y-3">
            {filtered.map((r: any) => (
              <Card
                key={r.id}
                className={`p-4 ${!r.isActive ? "opacity-60" : ""}`}
              >
                <div className="flex items-start gap-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span
                        className={`text-xs font-semibold px-2 py-0.5 rounded-full ${rewardTypeColors[r.rewardType] || "bg-slate-100 text-slate-600"}`}
                      >
                        {r.rewardType}
                      </span>
                      <span
                        className={`text-xs px-2 py-0.5 rounded-full ${r.userRole === "client" ? "bg-green-100 text-green-700" : "bg-blue-100 text-blue-700"}`}
                      >
                        {r.userRole === "client" ? "Cliente" : "Chofer"}
                      </span>
                      {!r.isActive && (
                    ...
                    <div className="flex items-center gap-3 mt-2 text-xs text-slate-500">
                      <span>
                        ...
                        <strong className="text-slate-700">
                          {r.rewardType === "badge"
                            ? "Badge"
                            : `$${Number(r.rewardValue).toFixed(2)}`}
                        </strong>
                      </span>
                      <span>
                        Trigger:{" "}
                        <strong className="text-slate-700">
                          {r.triggerCount} referido(s)
                        </strong>
                      </span>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="free_trip">Viaje gratis</option>
                        <option value="discount">Descuento %</option>
                        <option value="badge">Badge</option>
                        <option value="cash_bonus">Bono efectivo</option>
                      </select>
                    </div>
                  </div>
                  {[
                    {
                      key: "eventType",
                      label: "Tipo de evento (código)",
                      placeholder: "ej: referral_registered",
                    },
                    {
                      key: "eventLabel",
                      label: "Descripción del evento",
                      placeholder: "ej: Referido se registra",
                    },
                    {
                      key: "rewardLabel",
                      label: "Nombre de la recompensa",
                      placeholder: "ej: $2 crédito en wallet",
                    },
                    {
                      key: "rewardDescription",
                      label: "Descripción (opcional)",
                      placeholder: "ej: Tu amigo se registró...",
                    },
                  ].map(f => (
                    <div key={f.key}>
                      <label className="text-xs font-medium text-slate-600 mb-1 block">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className={`w-10 h-6 rounded-full transition-colors relative ${form.isActive ? "bg-green-500" : "bg-slate-300"}`}
                    >
                      <div
...
function DispatcherAdminPanel() {
  const { data: dispatchers, refetch } =
    trpc.referrals.getDispatchers.useQuery();
  const saveDispatcher = trpc.referrals.saveDispatcher.useMutation({
    onSuccess: () => {
      refetch();
      toast.success("Dispatcher guardado");
    },
  });
  const deleteDispatcher = trpc.referrals.deleteDispatcher.useMutation({
    onSuccess: () => {
      refetch();
      toast.success("Dispatcher eliminado");
    },
  });
  const [showForm, setShowForm] = useState(false);
  const [editingId, setEditingId] = useState<number | null>(null);
  ...
  const handleSave = () => {
    saveDispatcher.mutate(
      editingId
        ? { ...form, id: editingId, createdBy: 1 }
        : { ...form, createdBy: 1 }
    );
    setShowForm(false);
    setEditingId(null);
  ...
  const permLabels: Record<string, string> = {
    viewMap: "Ver mapa",
    assignTrips: "Asignar viajes",
    viewDrivers: "Ver conductores",
    contactUsers: "Contactar usuarios",
    viewTripHistory: "Ver historial",
    cancelTrips: "Cancelar viajes",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-slate-900">
            Gestión de Dispatchers
          </h2>
          <p className="text-sm text-slate-500">
            Crea operadores con permisos limitados para gestionar viajes
          </p>
        </div>
        <Button
          onClick={() => {
      ...
      {!dispatchers || dispatchers.length === 0 ? (
        <Card className="p-8 text-center">
          ...
          <p className="text-slate-500 font-medium">
            No hay dispatchers creados
          </p>
          <p className="text-sm text-slate-400 mt-1">
            Crea el primer dispatcher para delegar la gestión de viajes
          </p>
        </Card>
      ) : (
          ...
          {dispatchers.map((d: any) => (
            <Card key={d.id} className="p-4">
              <div className="flex items-start gap-3 mb-3">
                ...
                <span
                  className={`text-xs font-semibold px-2 py-1 rounded-full ${d.status === "active" ? "bg-green-100 text-green-700" : d.status === "suspended" ? "bg-red-100 text-red-700" : "bg-slate-100 text-slate-500"}`}
                >
                  {d.status === "active"
                    ? "Activo"
                    : d.status === "suspended"
              ...
              <div className="flex flex-wrap gap-1 mb-3">
                {Object.entries(d.permissions || {})
                  ...
                  .map(([k]) => (
                    <span
                      key={k}
                      className={`text-xs px-2 py-0.5 rounded-full ${permColors[k] === "red" ? "bg-red-100 text-red-600" : permColors[k] === "yellow" ? "bg-yellow-100 text-yellow-600" : "bg-green-100 text-green-700"}`}
                    >
                      {permLabels[k] || k}
                    </span>
                  ))}
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={() => deleteDispatcher.mutate({ id: d.id })}
                >
                  <Trash2 size={12} />
                </Button>
                <Button
                  size="sm"
                  className="flex-1 text-xs bg-blue-600 hover:bg-blue-700 text-white gap-1"
                  onClick={() => window.open("/dispatcher", "_blank")}
                >
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
            <h3 className="text-lg font-bold text-slate-900 mb-4">
              {editingId ? "Editar Dispatcher" : "Nuevo Dispatcher"}
            </h3>
            <div className="space-y-3">
              {[
                ...
                <div className="space-y-2">
                  {Object.entries(form.permissions).map(([key, val]) => (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${val ? "translate-x-4" : "translate-x-0.5"}`}
                        />
                      </button>
                    </div>
                  ))}
...
function ManualBookingPanel({ drivers }: { drivers: any[] }) {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      setLoading(false);
      toast.success(
        `✅ Reserva ${newBooking.id} creada${form.driverId ? " y asignada" : " — pendiente de conductor"}`
      );
    }, 800);
  };
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-900">
          Reserva Manual de Viaje
        </h2>
        <p className="text-sm text-slate-500 mt-1">
          Crea viajes manualmente para clientes que llaman por teléfono o no
          pueden usar la app
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6 space-y-4">
          <h3 className="font-semibold text-slate-900 flex items-center gap-2">
            <Phone size={16} className="text-green-600" /> Datos del viaje
          </h3>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: Calle 5 #123, Centro"
              className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              >
                ...
                {drivers
                  .filter(d => d.status === "active" && d.online)
                  .map(d => (
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Ej: Cliente con silla de ruedas, necesita ayuda..."
              rows={2}
              className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none resize-none"
            />
          </div>
          ...
          >
            {loading ? (
              ...
              <>
                <Phone size={16} /> Crear Reserva Manual
              </>
            )}
          </Button>
        </Card>
        ...
        <div className="space-y-4">
          <h3 className="font-semibold text-slate-900">
            Reservas Manuales Recientes
          </h3>
          {bookings.length === 0 ? (
            <Card className="p-8 text-center">
              <Phone size={32} className="mx-auto text-slate-300 mb-3" />
              <p className="text-slate-500 text-sm">
                No hay reservas manuales aún
              </p>
              <p className="text-slate-400 text-xs mt-1">
                Las reservas creadas aquí aparecerán en esta lista
              </p>
            </Card>
          ) : (
            <div className="space-y-3">
              {bookings.map(b => (
                <Card key={b.id} className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`text-xs px-2 py-0.5 rounded-full font-medium ${statusColors[b.status]}`}
                      >
                  ...
                  <div className="text-xs text-slate-600 space-y-1">
                    <p>
                      📍 <strong>Recogida:</strong> {b.pickup}
                    </p>
                    <p>
                      🏁 <strong>Destino:</strong> {b.dropoff}
                    </p>
                    <p>
                      🚗 <strong>Vehículo:</strong>{" "}
                      {vehicleTypes.find(v => v.id === b.vehicleType)?.label} ·{" "}
                      <strong>Conductor:</strong> {b.driver}
                    </p>
                    {b.notes && <p>📝 {b.notes}</p>}
                  </div>
                  <div className="flex gap-2 mt-3">
                    <button
                      ...
                      className="text-xs px-3 py-1.5 rounded-lg bg-green-100 text-green-700 font-medium hover:bg-green-200"
                    >
                      ✅ Completar
                    </button>
                    <button
                      ...
                      className="text-xs px-3 py-1.5 rounded-lg bg-red-100 text-red-700 font-medium hover:bg-red-200"
                    >
                      ❌ Cancelar
                    </button>
                  </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-slate-900">
            Precio Surge / Tarifa Dinámica
          </h2>
          <p className="text-sm text-slate-500 mt-1">
            Aumenta automáticamente las tarifas en horas de alta demanda
          </p>
        </div>
        <div className="flex items-center gap-3">
          <span className="text-sm font-medium text-slate-700">
            {surgeEnabled ? "Activo" : "Inactivo"}
          </span>
          <button
            onClick={() => {
              ...
              toast.success(
                surgeEnabled
                  ? "Precio surge desactivado"
                  : "Precio surge activado"
              );
            }}
            className={`w-14 h-7 rounded-full transition-colors relative ${surgeEnabled ? "bg-green-500" : "bg-slate-300"}`}
          >
            <div
              className={`absolute top-0.5 w-6 h-6 bg-white rounded-full shadow transition-transform ${surgeEnabled ? "translate-x-7" : "translate-x-0.5"}`}
            />
          </button>
        </div>
      </div>
      ...
      {/* Info banner */}
      <Card
        className={`p-4 border-2 ${surgeEnabled ? "border-green-300 bg-green-50" : "border-slate-200 bg-slate-50"}`}
      >
        <div className="flex items-start gap-3">
          <TrendingUp
            size={20}
            className={
              surgeEnabled ? "text-green-600 mt-0.5" : "text-slate-400 mt-0.5"
            }
          />
          <div>
            <p className="font-semibold text-slate-900 text-sm">
              {surgeEnabled
                ? "✅ Precio surge activo"
                : "⏸️ Precio surge pausado"}
            </p>
            <p className="text-xs text-slate-500 mt-0.5">
              {surgeEnabled
                ? "Las tarifas se multiplican automáticamente según las reglas configuradas abajo."
                : "Activa el interruptor para aplicar tarifas dinámicas en los horarios definidos."}
            </p>
          </div>
        </div>
      </Card>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-slate-900">
            Reglas de Precio Surge
          </h3>
          <Button
            onClick={() => setShowForm(true)}
            className="bg-green-500 hover:bg-green-600 text-white gap-2 text-sm"
            size="sm"
          >
        ...
        {rules.map(rule => (
          <Card
            key={rule.id}
            className={`p-4 ${!rule.active ? "opacity-60" : ""}`}
          >
            <div className="flex items-center gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span
                    className={`text-xs px-2 py-0.5 rounded-full font-bold ${multiplierColor(rule.multiplier)}`}
                  >
                    ×{rule.multiplier}
                  </span>
                  {!rule.active && (
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <div
                    className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${rule.active ? "translate-x-4" : "translate-x-0.5"}`}
                  />
                </button>
                <button
                  onClick={() => {
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none bg-white"
              />
            </div>
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setNewRule(r => ({ ...r, startTime: e.target.value }))
                  }
                  className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none bg-white"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setNewRule(r => ({ ...r, endTime: e.target.value }))
                  }
                  className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none bg-white"
                />
              </div>
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none bg-white"
                >
                  {[1.2, 1.3, 1.5, 1.75, 2.0, 2.5, 3.0].map(m => (
                    <option key={m} value={m}>
                      ×{m} ({Math.round((m - 1) * 100)}% más)
                    </option>
                  ))}
                </select>
              </div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button
                className="flex-1 bg-green-500 hover:bg-green-600 text-white"
                onClick={() => {
                  if (!newRule.name || newRule.days.length === 0) {
                    toast.error(
                      "Completa el nombre y selecciona al menos un día"
                    );
                    return;
                  }
                  setRules(prev => [
      ...
      <Card className="p-5 bg-slate-50">
        <h4 className="font-semibold text-slate-900 mb-3">
          ¿Cómo funciona el Precio Surge?
        </h4>
        <div className="grid sm:grid-cols-3 gap-4 text-sm text-slate-600">
          <div className="flex gap-2">
            <span className="text-lg">🕐</span>
            <p>
              <strong>Horario activo:</strong> El sistema detecta si la hora
              actual coincide con alguna regla activa.
            </p>
          </div>
          <div className="flex gap-2">
            <span className="text-lg">💰</span>
            <p>
              <strong>Precio multiplicado:</strong> La tarifa base se multiplica
              automáticamente. Ej: $10 × 1.5 = $15.
            </p>
          </div>
          <div className="flex gap-2">
            <span className="text-lg">📱</span>
            <p>
              <strong>Visible al cliente:</strong> El cliente ve el precio surge
              antes de confirmar su viaje con un aviso claro.
            </p>
          </div>
        </div>
      </Card>
...
function BroadcastPanel() {
  ...
  const { data: allAnnouncements, refetch } =
  ...
  const handleSend = async () => {
    ...
    const expiresAt = form.expiresHours
      ? Date.now() + parseInt(form.expiresHours) * 3600000
      : undefined;
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Envía anuncios directamente a los paneles de conductores, clientes o
            flotillas
          </p>
        </div>
        <Button
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          ...
          {
            label: "Activos",
            value: displayList.filter((a: any) => a.active).length,
            color: "text-green-600",
          },
          {
            label: "Fijados",
            value: displayList.filter((a: any) => a.pinned).length,
            color: "text-blue-600",
          },
          {
            label: "Inactivos",
      ...
      {showForm && (
        <Card className="p-5 border-2 border-green-200 bg-green-50/30">
          <h3 className="font-semibold text-slate-900 mb-4 flex items-center gap-2">
            <Send size={16} className="text-green-600" /> Crear Anuncio
          </h3>
          <div className="space-y-3">
            <div>
              <label className="text-xs font-medium text-slate-600 mb-1 block">
              ...
              <input
                ...
                placeholder="Ej: ¡Bonos de fin de semana!"
                className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none bg-white"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-green-500 outline-none bg-white resize-none"
              />
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setForm(f => ({ ...f, expiresHours: e.target.value }))
                  }
              ...
              <div className="flex items-end pb-1">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  >
                    <div
                      className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${form.pinned ? "translate-x-4" : "translate-x-0.5"}`}
                    />
                  </button>
            ...
            {form.title && (
              <div
                className={`p-3 rounded-xl border ${typeConfig[form.type].bg}`}
              >
                <p className="text-xs font-semibold text-slate-500 mb-1">
                  Vista previa:
                </p>
                <p
                  className={`font-bold text-sm ${typeConfig[form.type].color}`}
                >
                  {typeConfig[form.type].icon} {form.title}
                </p>
                {form.message && (
                  <p className="text-xs text-slate-600 mt-1">{form.message}</p>
                )}
                <p className="text-xs text-slate-400 mt-1">
                  Para: {targetConfig[form.target].icon}{" "}
                  {targetConfig[form.target].label}
                </p>
              </div>
            )}
      ...
      <div className="space-y-3">
        ...
        {displayList.length === 0 ? (
          <Card className="p-8 text-center">
            ...
            <p className="text-slate-400 text-xs mt-1">
              Crea tu primer anuncio para enviarlo a los paneles
            </p>
          </Card>
        ) : (
          displayList.map((ann: any) => {
            ...
            return (
              <Card
                key={ann.id}
                className={`p-4 ${!ann.active ? "opacity-60" : ""}`}
              >
                <div className="flex items-start gap-3">
                  <div
                    className={`w-9 h-9 rounded-xl flex items-center justify-center text-lg flex-shrink-0 ${tc.bg} border`}
                  >
                    {tc.icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                      ...
                      <span
                        className={`text-xs px-1.5 py-0.5 rounded-full font-medium ${ann.active ? "bg-green-100 text-green-700" : "bg-slate-100 text-slate-500"}`}
                      >
                    ...
                    <p className="text-xs text-slate-400 mt-1">
                      {new Date(ann.createdAt).toLocaleString("es", {
                        dateStyle: "short",
                        timeStyle: "short",
                      })}
                    </p>
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    >
                      <div
                        className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${ann.active ? "translate-x-4" : "translate-x-0.5"}`}
                      />
                    </button>
                    <button
                      onClick={async () => {
                        await deleteMutation.mutateAsync({ id: ann.id });
                        refetch();
...
function SafetyTipsAdminPanel() {
  const [audience, setAudience] = useState<"clients" | "drivers" | "fleet">(
    "clients"
  );
  const [showForm, setShowForm] = useState(false);
  const [editingId, setEditingId] = useState<number | null>(null);
  ...
  const filtered = (allTips as any[]).filter(
    (t: any) => t.audience === audience
  );
  const categories = Array.from(
    new Set(filtered.map((t: any) => String(t.category)))
  );
  ...
  const resetForm = () => {
    setForm({ category: "", title: "", tip: "", icon: "💡", priority: 5 });
    setEditingId(null);
    setShowForm(false);
  };

  const handleSave = async () => {
    if (!form.category.trim() || !form.title.trim() || !form.tip.trim()) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <Lightbulb size={20} className="text-amber-500" /> Consejos de
            Seguridad
          </h2>
          <p className="text-sm text-slate-500 mt-1">
            Edita los consejos que aparecen en la bombilla 💡 de cada panel
          </p>
        </div>
        <Button
          onClick={() => {
      ...
      <div className="flex gap-2 flex-wrap">
        {(["clients", "drivers", "fleet"] as const).map(a => (
          ...
          >
            {audienceConfig[a].icon} {audienceConfig[a].label} (
            {(allTips as any[]).filter((t: any) => t.audience === a).length})
          </button>
        ))}
      </div>
      ...
      {showForm && (
        <Card className="p-5 border-2 border-amber-200 bg-amber-50/30">
          <h3 className="font-semibold text-slate-900 mb-4">
            {editingId ? "Editar" : "Nuevo"} Consejo —{" "}
            {audienceConfig[audience].icon} {audienceConfig[audience].label}
          </h3>
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Antes del viaje"
                  list="cat-list"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Escribe el consejo detallado aquí..."
                rows={3}
      ...
      {categories.length === 0 ? (
        <Card className="p-8 text-center">
          ...
          <p className="text-slate-500 text-sm">
            No hay consejos para este grupo aún
          </p>
        </Card>
      ) : (
        <div className="space-y-4">
          {(categories as string[]).map(cat => (
            <div key={cat}>
              <h3 className="font-semibold text-slate-700 text-sm mb-2 flex items-center gap-2">
                ...
                {cat} ({filtered.filter((t: any) => t.category === cat).length})
              </h3>
              <div className="space-y-2">
                {filtered
                  ...
                  .map((tip: any) => (
                    <Card
                      key={tip.id}
                      className={`p-4 ${!tip.active ? "opacity-60" : ""}`}
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                          ...
                          >
                            <div
                              className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform ${tip.active ? "translate-x-4" : "translate-x-0.5"}`}
                            />
                          </button>
                          <button
...
function AdminNotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          className="absolute right-0 top-full mt-2 w-80 bg-white border border-slate-200 rounded-xl shadow-2xl"
          style={{ zIndex: 9999 }}
        >

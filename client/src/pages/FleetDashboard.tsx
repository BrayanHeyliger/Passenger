...
interface Trip {
  ...
  to: string;
  fare: string;
  status: "completed" | "in_progress" | "cancelled" | "requested";
  date: string;
  distance: string;
}
...
export default function FleetDashboard() {
  ...
  const handleDriverAction = (
    ...
    const pushMsgs: Record<string, string> = {
      approve: "✅ Conductor aprobado",
      suspend: "⚠️ Conductor suspendido",
      activate: "✅ Conductor activado",
      delete: "🗑️ Conductor eliminado",
    };
    const d = drivers.find(dr => dr.id === driverId);
    if (d)
      sendNotification(pushMsgs[action], {
        body: d.name,
        url: "/fleet-dashboard",
        tag: "fleet-action",
      });
        ...
        <div className="p-4 border-t border-slate-700">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Flotilla Admin</p>
            </div>
          </div>
          <Button
            variant="outline"
        ...
        <header className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center sticky top-0 z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              size="sm"
              onClick={() =>
                toast.info("Formulario de nuevo conductor próximamente")
              }
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    sub: `${MOCK_TRIPS.filter(t => t.status === "completed").length} completados`,
                    icon: Navigation,
                ...
                <Card className="p-4 border-yellow-200 bg-yellow-50">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-yellow-800">
                      ...
                      conductor(es) pendientes de aprobación
                    </h3>
                  </div>
                  {drivers
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            className="text-red-500 border-red-200 hover:bg-red-50 text-xs gap-1"
                          >
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-1">
                                ...
                                <button
                                  onClick={() => {
                                    setActiveChatTrip(`fleet-driver-${d.id}`);
                                    toast.info(
                                      `💬 Chat con ${d.name.split(" ")[0]} abierto`
                                    );
                                  }}
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-1">
                                <button
                                  onClick={() =>
                                    toast.info(
                                      "💬 Usa el chat interno para contactar al cliente"
                                    )
                                  }
                                  className="p-1.5 rounded-lg hover:bg-green-50 text-green-500"
                                  title="Contactar"
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  {
                    label: "Completados",
                    value: MOCK_TRIPS.filter(t => t.status === "completed")
                      .length,
                    color: "text-green-600",
                  },
                  {
                    label: "En progreso",
                    value: MOCK_TRIPS.filter(t => t.status === "in_progress")
                      .length,
                    color: "text-blue-600",
                  },
                  {
                    label: "Cancelados",
                    value: MOCK_TRIPS.filter(t => t.status === "cancelled")
                      .length,
                    color: "text-red-600",
                  },
                ].map((s, i) => (
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {MOCK_TRIPS.map(t => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            <p className="text-slate-900 text-xs">{t.from}</p>
                            <p className="text-slate-500 text-xs">→ {t.to}</p>
                          </td>
                          <td className="px-4 py-3 font-semibold text-green-600">
                            {t.fare}
                          </td>
                          ...
                          <td className="px-4 py-3">
                            <span
                              className={`px-2 py-1 rounded-full text-xs font-medium ${statusColors[t.status]}`}
                            >
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <Card key={i} className="p-5">
                    <div
                      className={`w-10 h-10 rounded-xl ${p.bg} flex items-center justify-center mb-3`}
                    >
          ...
          {activeTab === "settings" && (
            <div className="space-y-4 max-w-2xl">
              {[
                ...
                {
                  label: "Radio de operación (km)",
                  value: "50",
                  type: "number",
                },
                {
                  label: "Máximo conductores activos",
                  value: "10",
                  type: "number",
                },
              ].map((field, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <span
                  className={`px-2 py-0.5 rounded-full text-xs font-medium ${statusColors[selectedDriver.status]}`}
                >
            ...
            <div className="space-y-2 text-sm">
              {[
                ...
                {
                  label: "Calificación",
                  value: `${selectedDriver.rating || "Sin calificación"} ⭐`,
                },
            ...
            <div className="flex gap-2 mt-4">
              <Button
                className="flex-1 bg-green-500 hover:bg-green-600 text-white gap-2 text-sm"
                onClick={() => {
                  setActiveChatTrip(`fleet-driver-${selectedDriver.id}`);
                  setSelectedDriver(null);
                }}
              >
                <MessageCircle size={14} /> Chat Seguro
              </Button>
              <Button
                variant="outline"
